...
struct is_iterator {
  template <
      class U,
      typename enable_if<!is_convertible<U, const char*>::value, int>::type = 0>
...
class OutputDevice {
 ...
 public:
  ...
  inline int writeString(const char* arg,
                         size_t length,
